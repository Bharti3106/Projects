...
$sqlins="insert into tblcomplaints(userId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$area','$noc','$complaintdetials','$compfile')";
...
$msg1=" Hello ".$uname."\n\n Thanks For Contacting Us \n\n Your complain has been successfully filled and your complaintno is : ".$complainno." We Will Get Back to you soon ";

email_send($uemail,"Your Complaint Has Registered ", $msg1 );
...
<?php $sql=mysqli_query($con,"select areaName from area ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['areaName']);?>"><?php echo htmlentities($rw['areaName']);?></option>
<?php
}
?>
