...
move_uploaded_file($_FILES["image"]["tmp_name"],"engineerimages/".$imgnewfile);
// Query for insertion data into database
$query=mysqli_query($con,"update engineers set engineerImage='$imgnewfile' where engineerEmail='".$_SESSION['login']."'");
if($query)
{
...
<?php else:?>
	<img src="engineerimages/<?php echo htmlentities($engineerphoto);?>" width="256" height="256">
