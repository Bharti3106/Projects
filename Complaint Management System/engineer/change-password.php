...
{
     echo $sqlquery="SELECT password FROM engineers where password='".md5($_POST['password'])."' && engineerEmail='".$_SESSION['login']."'";
    $sql=mysqli_query($con,$sqlquery);
    $num=mysqli_fetch_array($sql);
    if($num>0)
    {
     $con=mysqli_query($con,"update engineers set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where engineerEmail='".$_SESSION['login']."'");
...
<html lang="en">
  <head>
    ...
    <title>CMS | Engineer Change Password</title>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Engineer Change Password</h4>
